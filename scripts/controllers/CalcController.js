class CalcController {
    ...
    addEventListenerAll(element, events, fn) {
        events.split(' ').forEach(event => {//split é usado para quebrar itens em arrays
    ...
    getResult() {
        console.log('getResult0', this._operation)
        try {
            console.log('getResult0', this._operation)
    ...
    initButtonsEvents() {//um bom jeito p fz a abstração é primeiro fz o q vc quer q aconteça.  
